...
// The InstructorFunc type is an adapter to allow the use of ordinary
// function as Instructor mutator.
type InstructorFunc func(context.Context, *ent.InstructorMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f InstructorFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.InstructorMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.InstructorMutation", m)
	}
	return f(ctx, mv)
}
...
// The MembersClassFunc type is an adapter to allow the use of ordinary
// function as MembersClass mutator.
type MembersClassFunc func(context.Context, *ent.MembersClassMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MembersClassFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.MembersClassMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MembersClassMutation", m)
	}
	return f(ctx, mv)
}
